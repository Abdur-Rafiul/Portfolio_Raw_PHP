                            ...
                            <table style="width:100%!important"
                                ...
                                <tbody class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button   id="counter_id" type="button"
                                                data-id="<?=$row['id']?>" data-title="<?=$row['title']?>" data-icon="<?=$row['icon']?>" data-pre="<?=$row['pre']?>" data-post="<?=$row['post']?>" class="btn edit2 btn-primary" data-toggle="modal"
